# MySQL script to create database for Canvas Data schema version 1.10.2
...
CREATE TABLE IF NOT EXISTS course_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp when the course object was created in Canvas',
  `start_at` TIMESTAMP NULL COMMENT 'Timestamp for when the course starts.',
  `conclude_at` TIMESTAMP NULL COMMENT 'Timestamp for when the course finishes',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "A course in the canvas system";
...
CREATE TABLE IF NOT EXISTS account_dim (
  ...
  `sis_source_id` VARCHAR(256) COMMENT 'Correlated id for the record for this course in the SIS system (assuming SIS integration is configured)'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "An account object in the Canvas system.  Accounts are most often used to represent a hierarchy of colleges, schools, departments, campuses, etc.";
...
CREATE TABLE IF NOT EXISTS pseudonym_dim (
  ...
  `last_request_at` TIMESTAMP NULL COMMENT 'TBD',
  `last_login_at` TIMESTAMP NULL COMMENT 'Timestamp of last time a user logged in with this pseudonym',
  `current_login_at` TIMESTAMP NULL COMMENT 'TBD',
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp when this pseudonym was created in Canvas',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp when this pseudonym was last updated in Canvas',
  `password_auto_generated` BOOLEAN COMMENT 'True if the password has been auto-generated',
  `deleted_at` TIMESTAMP NULL COMMENT 'Timestamp when the pseudonym was deleted (NULL if the pseudonym is still active)',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Pseudonyms are logins associated with users.";
...
CREATE TABLE IF NOT EXISTS assignment_dim (
  ...
  `due_at` TIMESTAMP NULL COMMENT 'Timestamp for when the assignment is due',
  `unlock_at` TIMESTAMP NULL COMMENT 'Timestamp for when the assignment is unlocked or visible to the user',
  `lock_at` TIMESTAMP NULL COMMENT 'Timestamp for when the assignment is locked',
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp of the first time the assignment was entered into the system',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp of the last time the assignment was updated',
  `peer_review_count` INTEGER UNSIGNED COMMENT 'The number of pears to assign for review if using algorithmic assignment',
  `peer_reviews_due_at` TIMESTAMP NULL COMMENT 'Timestamp for when peer reviews should be completed',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for for assignments.  There is one record in this table for each assignment.  Individual submissions of the assignment are in the submission_dim and submission_fact tables.";
...
CREATE TABLE IF NOT EXISTS assignment_fact (
  ...
  `peer_review_count` INTEGER UNSIGNED COMMENT 'The number of pears to assign for review if using algorithmic assignment',
  `assignment_group_id` BIGINT COMMENT 'Foreign key to the assignment group dimension table.'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Table contains measures related to assignments.";
...
CREATE TABLE IF NOT EXISTS submission_dim (
  ...
  `submitted_at` TIMESTAMP NULL COMMENT 'Timestamp of when the submission was submitted.',
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp of when the submission was created.',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp of when the submission was last updated.',
  ...
  `graded_at` TIMESTAMP NULL COMMENT 'Timestamp of when the submission was graded.',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "This table records the latest submission for an assignment.";
...
CREATE TABLE IF NOT EXISTS assignment_group_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Date/Time when the assignment group was created.',
  `updated_at` TIMESTAMP NULL COMMENT 'Date/Time when the assignment group was last updated.'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for assignment_groups.";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Measures for assignment_groups.";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Rules associated with an assignment group.";
...
CREATE TABLE IF NOT EXISTS communication_channel_dim (
  ...
  `updated_at` TIMESTAMP NULL COMMENT 'Date/Time when the quiz was last updated.'
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for a conversation";
...
CREATE TABLE IF NOT EXISTS conversation_message_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Date and time this message was created.',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for a message in a conversation";
...
CREATE TABLE IF NOT EXISTS conversation_message_participant_fact (
  ...
  `message_word_count` INTEGER UNSIGNED COMMENT 'The message size in words using space and common punctuation as word breaks.',
  `message_line_count` INTEGER UNSIGNED COMMENT 'The number of lines in a message.'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Fact table for each message in a conversation and each participant";
...
CREATE TABLE IF NOT EXISTS discussion_topic_dim (
  ...
  `last_reply_at` TIMESTAMP NULL COMMENT 'Timestamp of the last reply to this topic.',
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp when the discussion topic was first saved in the system.',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp when the discussion topic was last updated in the system.',
  `delayed_post_at` TIMESTAMP NULL COMMENT 'Timestamp when the discussion topic was/will be delay-posted',
  `posted_at` TIMESTAMP NULL COMMENT 'Timestamp when the discussion topic was posted',
  `deleted_at` TIMESTAMP NULL COMMENT 'Timestamp when the discussion topic was deleted.',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for discussion topics in Canvas.  Discussion topics are logical discussion threads.  They can have many discussion entries.   They also have their own message text for the message that started the topic.";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Measures for discussion topics/threads.";
...
CREATE TABLE IF NOT EXISTS discussion_entry_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp when the discussion entry was created.',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp when the discussion entry was updated.',
  `deleted_at` TIMESTAMP NULL COMMENT 'Timestamp when the discussion entry was deleted.',
  `depth` INTEGER UNSIGNED COMMENT 'Reply depth for this entry'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for discussion entries. Discussion entries are replies in a discussion topic.";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Measures for discussion entries.  Discussion entries are replies in a discussion topic.";
...
CREATE TABLE IF NOT EXISTS enrollment_term_dim (
  ...
  `date_start` TIMESTAMP NULL COMMENT 'Term start date',
  `date_end` TIMESTAMP NULL COMMENT 'Term end date',
  `sis_source_id` VARCHAR(256) COMMENT 'Correlated SIS id for this enrollment term (assuming SIS has been configured properly)'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Enrollment term describes the term or semester associated with courses (e.g. Fall 2013)";
...
CREATE TABLE IF NOT EXISTS course_section_dim (
  ...
  `start_at` TIMESTAMP NULL COMMENT 'Section start date',
  `end_at` TIMESTAMP NULL COMMENT 'Section end date',
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp for when this section was entered into the system.',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp for when the last time the section was updated',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for a section of a course";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Give the possible roles for an enrolled user";
...
CREATE TABLE IF NOT EXISTS enrollment_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp for when this section was entered into the system.',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp for when the last time the section was updated',
  `start_at` TIMESTAMP NULL COMMENT 'Enrollment start date',
  `end_at` TIMESTAMP NULL COMMENT 'Enrollment end date',
  `completed_at` TIMESTAMP NULL COMMENT 'Enrollment completed date',
  `self_enrolled` BOOLEAN COMMENT 'Enrollment was created via self-enrollment',
  `sis_source_id` VARCHAR(256) COMMENT 'Id of correlated enrollment in the SIS (assuming the SIS is configured properly)',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "An enrollment represents a user\'s association with a specific course and section";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Measures for enrollments";
...
CREATE TABLE IF NOT EXISTS group_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp when the group was first saved in the system.',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp when the group was last updated in the system.',
  `deleted_at` TIMESTAMP NULL COMMENT 'Timestamp when the group was deleted.',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for a Canvas navigation function";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for a navigation item";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Facts describing a single item in the navigation UI";
...
CREATE TABLE IF NOT EXISTS quiz_dim (
  ...
  `show_correct_answers_at` TIMESTAMP NULL COMMENT 'Day/Time when the correct answers would be shown.',
  `hide_correct_answers_at` TIMESTAMP NULL COMMENT 'Day/Time when the correct answers are to be hidden.',
  `created_at` TIMESTAMP NULL COMMENT 'Time when the quiz was created.',
  `updated_at` TIMESTAMP NULL COMMENT 'Time when the quiz was last updated.',
  `published_at` TIMESTAMP NULL COMMENT 'Time when the quiz was published.',
  `unlock_at` TIMESTAMP NULL COMMENT 'Day/Time when the quiz is to be unlocked for students.',
  `lock_at` TIMESTAMP NULL COMMENT 'Day/Time when the quiz is to be locked for students.',
  `due_at` TIMESTAMP NULL COMMENT 'Day/Time when the quiz is due.',
  `deleted_at` TIMESTAMP NULL COMMENT 'Time when the quiz was deleted.'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for quiz.";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Measures for quiz.";
...
CREATE TABLE IF NOT EXISTS quiz_submission_historical_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Time when the quiz submission was created.',
  `updated_at` TIMESTAMP NULL COMMENT 'Time when the quiz submission was last updated.',
  `started_at` TIMESTAMP NULL COMMENT 'Time at which the student started the quiz submission.',
  `finished_at` TIMESTAMP NULL COMMENT 'Time at which the student submitted the quiz submission.',
  `due_at` TIMESTAMP NULL COMMENT 'Time at which the quiz submission will be overdue, and will be flagged as a late submission.'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for all submitted quizzes";
...
CREATE TABLE IF NOT EXISTS quiz_submission_historical_fact (
  ...
  `date` TIMESTAMP NULL COMMENT 'Contains the same value as \'finished_at\'. Provided to support backward compatibility with the existing table in production.',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Measures for the all submitted quizzes";
...
CREATE TABLE IF NOT EXISTS quiz_submission_dim (
  ...
  `finished_at` TIMESTAMP NULL COMMENT 'Time at which the student submitted the quiz submission.',
  `due_at` TIMESTAMP NULL COMMENT 'Time at which the quiz submission will be overdue, and will be flagged as a late submission.'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for the last submitted quiz";
...
CREATE TABLE IF NOT EXISTS quiz_submission_fact (
  ...
  `extra_time` INTEGER UNSIGNED COMMENT 'Amount of extra time allowed for the quiz submission, in minutes.',
  `time_taken` INTEGER UNSIGNED COMMENT 'Time taken, in seconds, to finish the quiz.'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Measures for the last submitted quiz";
...
CREATE TABLE IF NOT EXISTS quiz_question_group_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Time when the quiz question was created.',
  `updated_at` TIMESTAMP NULL COMMENT 'Time when the quiz question was last updated.'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for quiz group.";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Measures related to quiz groups.";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes of a question associated with a quiz.";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Measures of a question associated with a quiz.";
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes of an answer related to a quiz question.";
...
CREATE TABLE IF NOT EXISTS quiz_question_answer_fact (
  ...
  `starting_range` DOUBLE COMMENT '(Used in \'numerical_question\' with answer type \'range_answer\', set to \'NULL\' otherwise) Start of the allowed range (inclusive).',
  `ending_range` DOUBLE COMMENT '(Used in \'numerical_question\' with answer type \'range_answer\', set to \'NULL\' otherwise) End of the allowed range (inclusive).'
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Measures for answers related to a quiz question.";
CREATE TABLE IF NOT EXISTS requests (
  ...
  `web_applicaiton_action` VARCHAR(256) COMMENT 'Controller the Canvas web application used to service this request. (There is a typo in the field name, in order to minimize impact, this will be changed in a future version of Canvas Data.)',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Pageview requests";
...
CREATE TABLE IF NOT EXISTS external_tool_activation_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp when the activation was created',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp when the activation was last updated',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for external tool (LTI) activations.
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Facts and denormalized dimensions for external tool (LTI) activations.";
...
CREATE TABLE IF NOT EXISTS wiki_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp when the wiki was first saved in the system.',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp when the wiki was last updated in the system.',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for wiki in canvas.";
...
CREATE TABLE IF NOT EXISTS wiki_page_dim (
  ...
  `created_at` TIMESTAMP NULL COMMENT 'Timestamp when the wiki page was created in the system.',
  `updated_at` TIMESTAMP NULL COMMENT 'Timestamp when the wiki page was last updated in the system.',
  ...
  `revised_at` TIMESTAMP NULL COMMENT 'Timestamp the wiki page was last revised in the system.',
...
) ENGINE = MyISAM DEFAULT CHARSET=utf8 COMMENT = "Attributes for wiki pages in canvas.";
