...
requirejs([ 'https://cdn.rawgit.com/jamesjonesmath/canvancement/master/quizzes/quizwiz/quizwiz-engine.js' ], function(QuizWiz) {
  ...
  // This script comes pre-configured to score unanswered questions as 0 points
  // and give full points for answered essay and file upload questions
  // It is the cofiguration used by Dr. Avi Naiman to speed up grading math homework
  ...
  var config = {
    ...
    'autoRun' : [ 'unanswered', 'full_points' ],
